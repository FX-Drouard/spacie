            ...
            <div id="mainPage">
                <header>
                    ...
                    <div id="onglet">
                        ...
                        <span id="onglet_notification" onClick={() => this.setPage(<Notification token={this.props.token} serveur={this.props.serveur} setPage={this.setPage} />)}><img src="https://media.spacie.fr/default/pages/svg/dm.svg" alt="Notification" /></span>
