...
class ResultatReacherche extends Component {
    ...
    render() {
        ...
        if (type === "Message") {
            ...
            return <div id="resultat_recherche"><MessageList setBody={this.props.setBody} token={this.props.token} serveur={this.props.serveur} setPage={this.props.setPage} resultat={resultat} />
            </div>
        }
